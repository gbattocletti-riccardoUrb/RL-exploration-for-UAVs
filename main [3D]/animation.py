...
def animate(drone_list, drone_selection_index, world, media_file_name, duration, save_animation, begin_time):
    ...
    def init_plot(map_object):
        ...
        selected_drone, = ax.plot([], [], 'ro', ms=5, zorder=16)
        ...
        return fig, ax, ms, drones, objectives, selected_drone, selected_objective, obstacles, trajectory,
    ...
    def init_animation():
        ...
        return drones, objectives, obstacles, trajectory,
    ...
    def main_animation(iteration):
        ...
        # trajectory.set_3d_properties(all_positions[drone_selection_index, z])
        ...
        if iteration%5 == 0:
            np.savetxt('3D_sim_obstacles.csv', np.round(drone_list[0].obstacle_list, 2))
            np.savetxt('3D_sim_trajectory_1.csv', np.round(drone_list[0].position_history, 2))
            np.savetxt('3D_sim_trajectory_2.csv', np.round(drone_list[1].position_history, 2))
            np.savetxt('3D_sim_trajectory_3.csv', np.round(drone_list[2].position_history, 2))
            np.savetxt('3D_sim_trajectory_4.csv', np.round(drone_list[3].position_history, 2))


        return drones, objectives, selected_drone, selected_objective, obstacles, trajectory,
    ...
    # covered_perc = []
    (fig, ax, ms, drones, objectives, selected_drone, selected_objective, obstacles, trajectory) = init_plot(world)
