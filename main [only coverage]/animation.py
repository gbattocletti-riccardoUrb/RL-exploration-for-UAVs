...
def animate(drone_list, drone_selection_index, world, media_file_name, duration, save_animation, begin_time):
    ...
    (ax_2, ms, drones_coverage, obstacles_coverage, trajectory_coverage, coverage_percentage, k_means_center, drone_0_coverage, drone_1_coverage, drone_2_coverage, drone_3_coverage) = init_plot_coverage(world)
