...
def main():
    ...
    save_animation = True
    video_duration = 69         # [s]
    media_file_name = join(os.getcwd(), '..', 'media', 'animation_coverage_final.mp4')
    ...
    predict_length = 15     # number of predict steps for the interpolated trajectory
    ...
    drone_list[1].set_initial_goal([11.4, 12.4])
    drone_list[2].set_initial_goal([8, 18])
