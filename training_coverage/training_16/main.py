...
args.model_number = '16'
args.episode_number = 500001
args.episode_steps = 6
args.substeps = 45
...
args.drone_matrix_dimension = 70
...
vision_range = 1.5  # [m] max distance at the drone can detect obstacles
...
for i in range(0, n_drones):
    ...
    drone.set_RL_path_planning_model(load_model('actor_12_2b', compile=False))
